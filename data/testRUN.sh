...
../soap.short -a ./short.fq -d ./prec_mmu17.fa -o short_map2_miRBase -s 6 -v 2 -n 1 -r 1 -p 8
touch long_map2_miRBase
../soap.short -a ./short.fq -d ./long.fa -o short_map2_long -s 6 -v 0 -n 1 -r 2 -p 8
perl ..//S1_reversed.pl short_map2_long ./long.fa S1_reversed
...
perl ..//S1_long_clustering.pl S1_reversed.2.cfs ./long.fa S1_reversed.2.cfsc
...
perl ..//get_selected_from_pool_fa.pl S1_reversed.2.cfsc.S75.id ./long.fa S1_reversed.2.cfsc.S75.fa
...
perl ..//get_selected_from_pool_fa.pl S1_reversed.2.cfsc.S75.psl.parsed.id ./long.fa S1_reversed.2.cfsc.S75.psl.parsed.fa
cat S1_reversed.2.cfsc.S75.psl.parsed.id | sort -u > S1_all_long.id
perl ..//get_selected_from_pool_fa.pl S1_all_long.id ./long.fa S1_all_long.fa
...
perl ..//S0_print.pl S1_reversed ./long.fa Candidate_premiRNAs.id S1_all_long.str1 short_map2_miRBase long_map2_miRBase Candidate_premiRNA.display.txt
